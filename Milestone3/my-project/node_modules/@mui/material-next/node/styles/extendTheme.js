...
function extendTheme(options = {}, ...args) {
  var _input$ref, _colorSchemesInput$li, _colorSchemesInput$li2, _input$sys, _input$sys2, _colorSchemesInput$li3, _colorSchemesInput$li4, _colorSchemesInput$li5, _colorSchemesInput$da, _input$ref2, _colorSchemesInput$da2, _colorSchemesInput$da3, _input$sys3, _input$sys4, _colorSchemesInput$da4, _colorSchemesInput$da5, _colorSchemesInput$li6, _colorSchemesInput$li7, _colorSchemesInput$da6, _colorSchemesInput$da7;
  const {
  ...
  const _createThemeWithoutVa = (0, _styles.createTheme)((0, _extends2.default)({}, input, {
      ...
      ref: (0, _extends2.default)({}, input.ref, {
        typeface: (0, _extends2.default)({}, _typeface.default, (_input$ref = input.ref) == null ? void 0 : _input$ref.typeface),
      ...
      sys: (0, _extends2.default)({}, input.sys, {
        typescale: (0, _extends2.default)({}, _typescale.default, (_input$sys = input.sys) == null ? void 0 : _input$sys.typescale),
        state: (0, _extends2.default)({}, _states.default, (_input$sys2 = input.sys) == null ? void 0 : _input$sys2.state),
      ...
      md3: {
        shape: (0, _extends2.default)({
          borderRadius: 100
        }, input == null ? void 0 : input.shape)
      },
  ...
  const {
    ...
    // @ts-ignore - it's fine, everything that is not supported will be spread
    ref: (0, _extends2.default)({}, input.ref, {
      typeface: (0, _extends2.default)({}, _typeface.default, (_input$ref2 = input.ref) == null ? void 0 : _input$ref2.typeface),
    ...
    sys: (0, _extends2.default)({}, input.sys, {
      typescale: (0, _extends2.default)({}, _typescale.default, (_input$sys3 = input.sys) == null ? void 0 : _input$sys3.typescale),
      state: (0, _extends2.default)({}, _states.default, (_input$sys4 = input.sys) == null ? void 0 : _input$sys4.state),
